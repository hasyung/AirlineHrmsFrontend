  ...
  function selectDefaultOptions($mdDropmenu, $mdConstant, $$rAF, $mdUtil,
      ...
      function activateInteraction() {
        ...
        opts.selectEl.on('keydown', function(ev) {
          switch (ev.keyCode) {
            ...
            //     var optNode = opts.selectEl.controller('mdDropMenu')
        ...
        function checkCloseMenu() {
          opts.restoreFocus = true;
          scope.$evalAsync(function() {
            // $mdDropmenu.hide(selectCtrl.ngModel.$viewValue);
            $mdDropmenu.hide();
          });
        }
      }
    ...
    function animateSelect(scope, element, opts) {
      var containerNode = element[0],
          ...
          _float = ($mdUtil.floatingScrollbars() ? 16 : 0),
          bounds = {
            left: parentRect.left + SELECT_EDGE_MARGIN,
            top: SELECT_EDGE_MARGIN,
            bottom: parentRect.height - SELECT_EDGE_MARGIN,
            right: parentRect.width - SELECT_EDGE_MARGIN - _float
          },
          spaceAvailable = {
          ...
          selectedNode = selectNode.querySelector('md-drop-option[selected]'),
          optionNodes = selectNode.getElementsByTagName('md-drop-option'),
          optgroupNodes = selectNode.getElementsByTagName('md-drop-optgroup');
...
DropProvider.$inject = ["$$interimElementProvider"];
